...
import { onGoogleButtonPress, signIn } from '../../Services/Auth'
...
import { signinList } from '../../types/NavigationTypes'



const { height } = Dimensions.get('window');
const SignIn: React.FC<signinList> = ({ navigation }) => {
    ...
    return (
        <Block
            ...
            <View style={styles.main}>
                ...
                <FilledBlueButton name='SIGN IN' onPress={handleSignUpPress} />
                <Text style={styles.t1}>Did'nt Have an account? <Pressable onPress={() => { navigation.navigate('SignUp') }}  ><Text style={{
                    color: 'black', fontWeight: "600", paddingTop: 5
                }}>Sign Up</Text></Pressable></Text>

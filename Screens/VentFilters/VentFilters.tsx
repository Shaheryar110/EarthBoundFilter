...
const VentFilters = () => {
  ...
  const handleAddToCart = () => {
    const cartItem = {
      name: 'Vent Filter For Home',
      imageUrl:
        'https://firebasestorage.googleapis.com/v0/b/examtutorservice.appspot.com/o/p2.png?alt=media&token=7c4b0408-d07e-474e-8b2b-908cf146ff93',
      productId: '2', // Replace with your actual product ID
  ...
  return (
    <Block
      ...
      <View style={styles.main}>
        <Text style={styles.mainHeading}>Vent Filters For Home</Text>
        ...
        <View style={styles.margins}>
          <View style={styles.spacebtw}>
            <Text style={styles.filters}>Vent Filters For Home</Text>
            <AirbnbRating
              size={20}
          ...
          <Text style={styles.texts}>
            Price: <Text style={styles.span}>$10.00</Text>
          </Text>
          <Text style={styles.texts}>Availability: In Stock</Text>
          <Text style={styles.texts}>
            First select product then select sizes, sizes are associated with
            products.
          </Text>
            ...
            {sizes.map((size, index) => (
              <Pressable
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      selectedSize === size ? '#54A433' : 'white',
                    elevation: 3,
                  },
                ]}
          ...
          <View>
            ...
            <View style={styles.flex}>
              <View style={styles.quanitty}>
                <Pressable
                  style={[styles.sizeBox, {paddingHorizontal: 20}]}
                  onPress={() => setQuantity(Math.max(1, quantity - 1))}>
                  <Text style={[styles.texts, {fontSize: 13, color: 'black'}]}>
                    -
                  </Text>
                </Pressable>
                <Text style={[styles.texts, {fontSize: 13, color: 'black'}]}>

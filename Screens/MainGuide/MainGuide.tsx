...
type MainGuideProps = {
    navigation: StackNavigationProp<RootGuideStackParamList, 'GuideSecond'>;
    onGuideComplete: () => void;
};

const MainGuide: React.FC<MainGuideProps> = ({ onGuideComplete, navigation }) => {
    ...
    return (
        <ImageBackground source={require("../../assets/img/g11.png")} style={styles.backgroundImage}>
            <View style={styles.container}>
                <View style={styles.btnGrp} >
                    ...
                    <Pressable style={[styles.signInButton, { backgroundColor: "#02A9E8", borderColor: "#02A9E8", borderWidth: 2 }]} onPress={() => { navigation.navigate('GuideSecond') }}  >

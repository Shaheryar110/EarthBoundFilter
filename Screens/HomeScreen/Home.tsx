...
const Home: React.FC<HomeScreenProps> = ({navigation}) => {
  ...
  const cardText = ['Flat HVAC Filter', 'Vent Filter For Home'];
      ...
      <View style={{position: 'relative'}}>
        <View style={styles.homeBox}>
          ...
          <Text
            ...
            No one will say no to clean air
          </Text>
        </View>
        <Text
          style={[
          ...
          Patent Pending And Approved
        </Text>
        <BannerCarousel carouselData={data1} itemsToShow={2} />
        <View style={styles.homeBox}>
          ...
          <View
            style={[
              styles.catBox,
              {gap: 10, paddingHorizontal: 10, paddingVertical: 1},
            ]}>
            {cardText.map((data, index) => {
              return (
                <Pressable
                  style={styles.catgeroySingle}
                  key={index}
          ...
          <Text style={[styles.ctHead, {padding: 10, marginTop: 15}]}>

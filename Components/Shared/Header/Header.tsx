        ...
        <>
            <View style={styles.headerBox} >
                ...
                <Image
                    ...
                    style={{ height: 50, width: 250, objectFit: "contain" }}
                />
                {/* <Text style={{ color: "#48c3f2", fontFamily: "GreatVibes-Regular" }} >Who Would Say No to Clean Air</Text> */}
                <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }} >

                    <Pressable style={styles.notification} onPress={() => navigation.navigate('cart')}>
                        <View style={styles.number} >
                            <Text style={{ fontWeight: "600" }} >{cart?.items?.length}</Text>
                        </View>
                        <AntDesign name='shoppingcart' style={{ fontSize: 25, color: "white" }} />
                    </Pressable>
                </View>
            </View>
        </>

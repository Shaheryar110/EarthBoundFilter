...
import { RootBottomTabParams, RootStackParamListAPP } from '../types/NavigationTypes';
...
const BottomTabNavigation = () => {
    const navigationCustom = useNavigation<StackNavigationProp<RootStackParamListAPP>>();
        ...
        <Tab.Navigator
            ...
            <Tab.Screen
                options={{
                    ...
                    tabBarLabelStyle: { marginBottom: 10 },
                    tabBarIcon: ({ color, size }) => (
                        <MaterialCommunityIcons name="view-dashboard-outline" color={color} size={29} />
                    ),
                }}
                name="Menu"
            ...
            <Tab.Screen
                options={{
                    ...
                    tabBarLabelStyle: { marginBottom: 10 },
                    tabBarIcon: ({ color, size }) => (
                        <MaterialCommunityIcons name="contacts-outline" color={color} size={30} />
                    ),
                }}
                name="Heart"
                component={Heart}
